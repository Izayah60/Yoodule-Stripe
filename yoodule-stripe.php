 ...
 * Description: Fetch all the prices from Stripe via Ajax to backend and rendered into WordPress pages
 * Author: Isaiah Ikharona
 * Author URI: https://github.com/Izayah60/Yoodule-Stripe
 * version: 1.0.0
...
function yoodule_rest_ajax_shortcode () {
  ...
  <thead>
    ...
    wp_enqueue_script( 'stripe-ajax-scripts', plugins_url( 'assets/js/stripe-ajax.js', __FILE__ ), ['jquery'], '1.0.0', true );
